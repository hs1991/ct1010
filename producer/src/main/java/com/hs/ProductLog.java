...
public class ProductLog {
     ...
     * @version: V1.0
     */
    private Calendar randomDate(String startDate, String endDate) throws Exception {
    ...
    //随机生成通话内容
    private String produceLog() throws Exception {
...
//                .append(durationString);
    ...
    public void writeLog(String filePath, ProductLog productLog) {
        ...
        try {
            ...
            while (true) {
                String log = productLog.produceLog();
