...
import com.sh.utils.HBaseFilterUtil;
...
public class ScanTest1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Filter filter1 = HBaseFilterUtil.eqFilter("f1", "call1", Bytes.toBytes("18411925860"));
       Filter filter2 = HBaseFilterUtil.eqFilter("f1", "call2", Bytes.toBytes("18411925860"));
      ...
      Filter filter3 = HBaseFilterUtil.orFilter(filter1, filter2);
        ...
        Filter filter5 = HBaseFilterUtil.lteqFilter("f1", "buildTime", Bytes.toBytes("2017-10"));
